    ...
    spec:
      ...
      - name: busybox
        ...
        args:
          ...
          - |
            while true; do
              echo "$(date): Busybox write" >> /shared-data/log.txt
              sleep 5
            done
        volumeMounts:
        - name: shared-storage
...
```
```
kubectl describe pods shared-volume-app
kubectl logs -l app=shared-volume-app -c multitool -f
```
<img width="1268" height="1386" alt="image" src="https://github.com/user-attachments/assets/b874f982-b77b-4ee7-a0b0-6c12d55da7ef" />

<img width="867" height="262" alt="image" src="https://github.com/user-attachments/assets/6ee5283b-514d-449c-b827-97b10722994a" />
